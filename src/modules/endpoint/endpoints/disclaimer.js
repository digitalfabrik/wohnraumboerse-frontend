...
export default new EndpointBuilder('disclaimer')
  .withStateToUrlMapper(state => `https://cms.integreat-app.de/${cityConfig.cmsName}/de/wp-json/extensions/v0/modified_content/disclaimer?since=1970-01-01T00:00:00Z`)
  .withMapper(json => {
    if (isEmpty(json)) {
